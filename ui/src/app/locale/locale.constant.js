    ...
    .constant('locales',
        {
            'en_US': {
                ...
                "asset": {
                    ...
                    "add": "Add Asset",
                    "assign-to-customer": "Assign to Site",
                    "assign-asset-to-customer": "Assign Asset(s) To Site",
                    "assign-asset-to-customer-text": "Please select the assets to assign to the Site",
                    "no-assets-text": "No assets found",
                    "assign-to-customer-text": "Please select the Site to assign the asset(s)",
                    "public": "Public",
                    "assignedToCustomer": "Assigned to Site",
                    "make-public": "Make asset public",
                    "make-private": "Make asset private",
                    "unassign-from-customer": "Unassign from Site",
                    "delete": "Delete asset",
                    ...
                    "assign-assets-text": "Assign { count, select, 1 {1 asset} other {# assets} } to Site",
                    "delete-assets": "Delete assets",
                    "unassign-assets": "Unassign assets",
                    "unassign-assets-action-title": "Unassign { count, select, 1 {1 asset} other {# assets} } from Site",
                    ...
                    "unassign-asset-text": "After the confirmation the asset will be unassigned and won't be accessible by the Site.",
                    "unassign-asset": "Unassign asset",
                    "unassign-assets-title": "Are you sure you want to unassign { count, select, 1 {1 asset} other {# assets} }?",
                    "unassign-assets-text": "After the confirmation all selected assets will be unassigned and won't be accessible by the Site.",
                ...
                "customer": {
                    "customer": "Site",
                    "customers": "Sites",
                    "management": "Sites Management",
                    "dashboard": "Site Dashboard",
                    "dashboards": "Site Dashboards",
                    ...
                    "add": "Add Site",
                    "delete": "Delete Site",
                    "manage-customer-users": "Manage Site users",
                    "manage-customer-devices": "Manage Site devices",
                    "manage-customer-dashboards": "Manage Site dashboards",
                    "manage-public-devices": "Manage public devices",
                    "manage-public-dashboards": "Manage public dashboards",
                    "manage-customer-assets": "Manage Site assets",
                    "manage-public-assets": "Manage public assets",
                    "add-customer-text": "Add new Site",
                    "no-customers-text": "No Sites found",
                    "customer-details": "Site details",
                    "delete-customer-title": "Are you sure you want to delete the Site '{{customerTitle}}'?",
                    "delete-customer-text": "Be careful, after the confirmation the Site and all related data will become unrecoverable.",
                    ...
                    "delete-customers-text": "Be careful, after the confirmation all selected Sites will be removed and all related data will become unrecoverable.",
                    "manage-users": "Manage sites",
                    ...
                    "events": "Events",
                    "copyId": "Copy Site Id",
                    "idCopiedMessage": "Site Id has been copied to clipboard",
                    "select-customer": "Select Site",
                    "no-customers-matching": "No Sites matching '{{entity}}' were found.",
                    "customer-required": "Site is required"
                },
                "datetime": {
                    "date-from": "Date from",
                    "time-from": "Time from",
                ...
                "dashboard": {
                    ...
                    "add": "Add Dashboard",
                    "assign-dashboard-to-customer": "Assign Dashboard(s) To Site",
                    "assign-dashboard-to-customer-text": "Please select the dashboards to assign to the Site",
                    "assign-to-customer-text": "Please select the Site to assign the dashboard(s)",
                    "assign-to-customer": "Assign to Site",
                    "unassign-from-customer": "Unassign from Site",
                    ...
                    "assign-dashboards-text": "Assign { count, select, 1 {1 dashboard} other {# dashboards} } to Site",
                    "delete-dashboards": "Delete dashboards",
                    "unassign-dashboards": "Unassign dashboards",
                    "unassign-dashboards-action-title": "Unassign { count, select, 1 {1 dashboard} other {# dashboards} } from Site",
                    ...
                    "unassign-dashboard-text": "After the confirmation the dashboard will be unassigned and won't be accessible by the Site.",
                    ...
                    "unassign-dashboards-text": "After the confirmation all selected dashboards will be unassigned and won't be accessible by the Site.",
                    ...
                    "socialshare-text": "'{{dashboardTitle}}' powered by Graha Sumber Prima Elektronik",
                    "socialshare-title": "'{{dashboardTitle}}' powered by Graha Sumber Prima Elektronik",
                ...
                "device": {
                    ...
                    "add": "Add Device",
                    "assign-to-customer": "Assign to Site",
                    "assign-device-to-customer": "Assign Device(s) To Site",
                    "assign-device-to-customer-text": "Please select the devices to assign to the Site",
                    "make-public": "Make device public",
                    "make-private": "Make device private",
                    "no-devices-text": "No devices found",
                    "assign-to-customer-text": "Please select the Site to assign the device(s)",
                    ...
                    "assign-devices-text": "Assign { count, select, 1 {1 device} other {# devices} } to Site",
                    "delete-devices": "Delete devices",
                    "unassign-from-customer": "Unassign from Site",
                    "unassign-devices": "Unassign devices",
                    "unassign-devices-action-title": "Unassign { count, select, 1 {1 device} other {# devices} } from Site",
                    ...
                    "unassign-device-text": "After the confirmation the device will be unassigned and won't be accessible by the Site.",
                    ...
                    "unassign-devices-text": "After the confirmation all selected devices will be unassigned and won't be accessible by the Site.",
                ...
                "plugin": {
                    ...
                    "description": "Description",
                    "add": "Add Add On",
                    "delete-plugin-title": "Are you sure you want to delete the Add On '{{pluginName}}'?",
                    "delete-plugin-text": "Be careful, after the confirmation the Add On and all related data will become unrecoverable.",
                    ...
                    "delete-plugins-text": "Be careful, after the confirmation all selected Add On will be removed and all related data will become unrecoverable.",
                    "add-plugin-text": "Add new Add On",
                    "no-plugins-text": "No Add On found",
                    "plugin-details": "Add On details",
                    "api-token": "API token",
                    "api-token-required": "API token is required.",
                    "type": "Add On type",
                    "type-required": "Add On type is required.",
                    "configuration": "Add On configuration",
                    "system": "System",
                    "select-plugin": "Select Add On",
                    "plugin": "Plugin",
                    "no-plugins-matching": "No Add On matching '{{entity}}' were found.",
                    "plugin-required": "Add On is required.",
                    "plugin-require-match": "Please select an existing Add on.",
                    "events": "Events",
                    "details": "Details",
                    "import": "Import Add On",
                    "export": "Export Add On",
                    "export-failed-error": "Unable to export Add On: {{error}}",
                    "create-new-plugin": "Create new Add On",
                    "plugin-file": "Add On file",
                    "invalid-plugin-file-error": "Unable to import Add On: Invalid Add On data structure.",
                    "copyId": "Copy Add On Id",
                    "idCopiedMessage": "Add On Id has been copied to clipboard"
                },
                "position": {
                    "top": "Top",
                    "bottom": "Bottom",
                ...
                "rule-plugin": {
                    "management": "Rules and Add On Management"
                },
                "tenant": {
                    "tenant": "Customer",
                    "tenants": "Customers",
                    ...
                    "add": "Add Customer",
                    "admins": "Admins",
                    "manage-tenant-admins": "Manage Customer admins",
                    "delete": "Delete Customer",
                    "add-tenant-text": "Add new Customer",
                    "no-tenants-text": "No Customers found",
                    "tenant-details": "Customer details",
                    "delete-tenant-title": "Are you sure you want to delete the Customer '{{tenantTitle}}'?",
                    "delete-tenant-text": "Be careful, after the confirmation the Customer and all related data will become unrecoverable.",
                    ...
                    "delete-tenants-text": "Be careful, after the confirmation all selected Customers will be removed and all related data will become unrecoverable.",
                    "title": "Title",
                    "title-required": "Title is required.",
                    "description": "Description",
                    "details": "Details",
                    ...
                    "no-tenants-matching": "No Customers matching '{{entity}}' were found.",
                    "tenant-required": "Customer is required"
                },
                "timeinterval": {
                ...
                "user": {
                    "user": "User",
                    "users": "Users",
                    "customer-users": "Site Users",
                    "tenant-admins": "Customer Admins",
